...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ExpenseCategoryServiceAPIException.class)
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ResponseEntity<ErrorDetails> handleExpenseCategoryServiceAPIException(
            ExpenseCategoryServiceAPIException exception,
            WebRequest webRequest) {
        var errorDetails = ErrorDetails.builder()
                .message(exception.getMessage())
